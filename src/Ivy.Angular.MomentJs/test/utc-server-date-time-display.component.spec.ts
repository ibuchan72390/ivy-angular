...
describe('UtcServerDateDisplayComponent: Module Tests', () => {
    ...
    // Variables
    let fixture: ComponentFixture<IvyAngularUtcServerDateTimeDisplayComponent>;
    let sut: IvyAngularUtcServerDateTimeDisplayComponent;
    ...
    beforeEach(() => {
        ...
        fixture = TestBed.createComponent(IvyAngularUtcServerDateTimeDisplayComponent);
...
describe('UtcServerDateDisplayComponent: Component Tests', () => {
    ...
    it('UtcServerDateDisplay renders a UTC date as expected', () => {
        ...
        expect(dateFormatSpy).toHaveBeenCalledWith(localResult, 'YYYY/MM/DD, h: mm a');
