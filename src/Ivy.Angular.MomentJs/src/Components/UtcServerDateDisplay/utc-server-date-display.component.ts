...
@Component({
    selector: 'ivy-utc-server-date-display',
    template: '<span *ngIf="date != null">{{date | amFromUtc | amLocal | amDateFormat: \'YYYY/MM/DD\'}}</span>'
})
export class IvyAngularUtcServerDateDisplayComponent {
