...
@Component({
    selector: 'ivy-utc-server-date-time-display',
    template: '<span *ngIf="date != null">{{date | amFromUtc | amLocal | amDateFormat: \'YYYY/MM/DD, h: mm a\'}}</span>'
})
export class IvyAngularUtcServerDateTimeDisplayComponent {
